 ...
 * @param fds The struct storing all information requried for the file descriptors
 */
void init_file_descriptors(struct file_descriptors* fds);

/**
 * @brief Closes current file desciptors and sets the terminal back to std input and output
 * @param fds The struct storing all information requried for the file descriptors
 */
...
/**
 * @brief Sets the current file descriptors back to terminal stdio and stdout, and moves next input to current input
 * @param fds The struct storing all information requried for the file descriptors
 */
